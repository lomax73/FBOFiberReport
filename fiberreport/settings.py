"""
Django settings for fiberreport project.
"""
...
SECRET_KEY = os.environ.get(
    'DJANGO_SECRET_KEY',
    'django-insecure-e=uw&q9h@_cwx369zcs9ov4d_qjsw&i)az1vwv=ndql^2k3r)*',
)
...
# qui teniamo solo il client_id (UUID) sul Project e risolviamo nome/
...
# posto di disattivare del tutto la verifica (RedFlag id 78). Vuoto in locale,
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'collaudi.context_processors.portal_public_url',
            ],
        },
    },
]

WSGI_APPLICATION = 'fiberreport.wsgi.application'


# Database — SQLite: volumi piccoli (progetti, tratte, misure, loghi).
